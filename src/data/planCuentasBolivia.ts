// ============================================================
// Plan de Cuentas Bolivia (Cochabamba) — dentro de src/
// Importado por chart-of-accounts.service.ts
// La copia en prisma/seeds/ se usa solo para el seed CLI.
// ============================================================
...
export async function seedPlanCuentasBolivia(
  prisma: PrismaClient,
  empresaId: string
): Promise<void> {
...
async function seedTasaIVA(
  ...
  await prisma.tasaImpuesto.create({
    data: {
      ...
      porcentaje:        13.00,
      tipo:              "trasladado",
      cuenta_debito_id:  idPorCodigo.get("1.1.08") ?? null,
      cuenta_credito_id: idPorCodigo.get("2.1.03") ?? null,
    },
  });
